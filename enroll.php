...
<div class="bg-white text-black p-6 rounded-lg shadow-md max-w-md w-full z-10 relative">
  <form action="enroll.php" method="POST">
    ...
    <label>Email:</label>
    <input type="email" name="email" class="text-black bg-white px-3 py-2 rounded-lg shadow-md border border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500">
    <br><br>
